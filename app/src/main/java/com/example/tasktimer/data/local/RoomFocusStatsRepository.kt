...
class RoomFocusStatsRepository(
    ...
    override suspend fun getStats(period: StatsPeriod): FocusStats {
        ...
        val allTasks = taskRepository.getTasksByDateRange(startDate, endDate)
        
        // Buscar tasks completadas do período
        val completedTasks = taskRepository.getCompletedTasksByDateRange(startDate, endDate)
        
        // Buscar todas as categorias para mapear os nomes
        val categories = categoryRepository.getCategoriesMap()
